...
m4 <- hashmap()
m4[[c(1,2,3,4)]] <- c(1,1,1,1,1,1)
m4[[c(2,1,3,4)]] <- c(0,1,1,1,1,1)
m4[[c(3,1,2,4)]] <- c(1,0,1,0,1,1)
m4[[c(1,3,2,4)]] <- c(1,1,1,0,1,1)
m4[[c(2,3,1,4)]] <- c(0,0,1,1,1,1)
m4[[c(3,2,1,4)]] <- c(0,0,1,0,1,1)
m4[[c(3,2,4,1)]] <- c(0,0,0,0,1,1)
m4[[c(2,3,4,1)]] <- c(0,0,0,1,1,1)
m4[[c(4,3,2,1)]] <- c(0,0,0,0,0,0)
m4[[c(3,4,2,1)]] <- c(0,0,0,0,0,1)
m4[[c(2,4,3,1)]] <- c(0,0,0,1,1,0)
m4[[c(4,2,3,1)]] <- c(0,0,0,1,0,0)
